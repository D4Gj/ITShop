...
namespace ITShopBusinessLogic.BusinessLogic
{
    public class SaveToPdf
    {
        public static void CreateDoc(PdfInfo info)
        {
            ...
            {
                Table = table,
                Texts = new List<string> { "id Операции", "id Компонента", "Название", "Количество", "Вид движения","Дата" },
                Style = "NormalTitle",
                ParagraphAlignment = ParagraphAlignment.Center
            });
            foreach (var operation in info.Opetarions)
            {
                CreateRow(new PdfRowParameters
                {
                    Table = table,
                    Texts = new List<string> { 
                        ...
                        operation.IdComponents.ToString(),
                        operation.NameComponent.ToString(),
                        operation.Count.ToString(),
                        operation.TypeMove.ToString(),
